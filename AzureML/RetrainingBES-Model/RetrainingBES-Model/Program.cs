...
namespace CallBatchExecutionService
{
    ...
    class Program
    {
        ...
        static async Task InvokeBatchExecutionService()
        {
            ...
            const string BaseUrl = "https://ussouthcentral.services.azureml.net/workspaces/8dd9fd82d81f4d44831f1aeda626e14c/services/9237d3b0ba65445a8e5a7e840d08b60b/jobs";

            const string StorageAccountName = "poorvaja1storage"; // Replace this with your Azure Storage Account name
            const string StorageAccountKey = "thK8sIudnmzbjRWsJbOTwDlSHqrMeFDBCtNucemLBbKJcPnl3y+KQpx0Cr9mOJkqoE7kwjlJus1T4nIQC2uhkg=="; // Replace this with your Azure Storage Key
            const string StorageContainerName = "germanretrain"; // Replace this with your Azure Storage Container name
            string storageConnectionString = string.Format("DefaultEndpointsProtocol=https;AccountName={0};AccountKey={1}", StorageAccountName, StorageAccountKey);
            const string apiKey = "Q8L3NmHCi66YDKe3IkhBGWf4A5cXJH6tp+tVezTNQm3IGhhaXSzNvhQQ3Bdrpzw9GU1S7nRPm0lWlWrFC0JRIA=="; // Replace this with the API key for the web service
            ...
            UploadFileToBlob("new data.csv" /*Replace this with the location of your input file*/,
               "new datadatablob.csv" /*Replace this with the name you would like to use for your Azure blob; this needs to have the same extension as the input file */,
                ...
                var request = new BatchExecutionRequest()
                {
                    ...
                    Inputs = new Dictionary<string, AzureBlobDataReference>()
                    {

                        {
                            ...
                            new AzureBlobDataReference()
                            {
                                ...
                                RelativeLocation = string.Format("{0}/new datadatablob.csv", StorageContainerName)
                            }
                        },
                    },
                    ...
                    Outputs = new Dictionary<string, AzureBlobDataReference>()
                    {

                        {
                            ...
                            {
                                ConnectionString = storageConnectionString,
                                RelativeLocation = string.Format("/{0}/trained modelresults.ilearner", StorageContainerName)
                            }
                        },

                        {
                            "Evaluation New Trained data",
                            new AzureBlobDataReference()
                            {
                                ConnectionString = storageConnectionString,
                                RelativeLocation = string.Format("/{0}/Evaluation New Trained dataresults.csv", StorageContainerName)
                            }
                        },
                    },
